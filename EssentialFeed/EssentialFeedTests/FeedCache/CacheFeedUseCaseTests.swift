...
class CacheFeedUseCaseTests: XCTestCase {
    ...
    func test_save_requestsNewCacheInsertionOWithTimeStampOnSuccessDeletion() {
        ...
        XCTAssertEqual(store.receivedMessages, [.deleteCahedFeed, .insert(items.local, timestamp)])
    }
    ...
    func test_save_succedesOnSuccessfulCacheInsertion() {
        let (sut, store) = makeSUT()
    ...
    func test_save_doesNotDeliverDeletionErrorAfterIntanceHasBeenDeallocated() {
    ...
    func test_save_doesNotDeliverInsertionErrorAfterIntanceHasBeenDeallocated() {
        let store = FeedStoreSpy()
        var sut: LocalFeedLoader? = LocalFeedLoader(store: store, currentDate: Date.init)
